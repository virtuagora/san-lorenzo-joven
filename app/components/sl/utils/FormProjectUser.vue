<template>
  <section>
    ...
    <p>Se debe asignar a la presentación de la propuesta una persona como responsable para su seguimiento. Los siguientes campos se completarán automáticamente de acuerdo a los datos de su registro. <span class="is-600">Estos campos no serán visibles públicamente, son a efecto de la convocatoria a subir propuestas</span>.</p>
    </div>
    <div class="columns">
      <div class="column">
        <div class="field">
          <h1 class="title is-4" :class="{'has-text-danger': errors.has('project.author_names')}">
            <i class="fas fa-caret-right"></i>&nbsp;Su nombre
          </h1>
          <div class="control">
            <input
              ...
              class="input is-large is-static"
      ...
      <div class="column">
        <div class="field">
          <h1 class="title is-4" :class="{'has-text-danger': errors.has('project.author_surnames')}">
            <i class="fas fa-caret-right"></i>&nbsp;Su apellido
          </h1>
          <div class="control">
            <input
      ...
      <div class="column">
        <div class="field">
          <h1 class="title is-4" :class="{'has-text-danger': errors.has('project.author_email')}">
            <i class="fas fa-caret-right"></i>&nbsp;Su correo electrónico
          </h1>
          <div class="control">
            <input
      ...
      <div class="column">
        <div class="field">
          <h1 class="title is-4" :class="{'has-text-danger': errors.has('project.author_dni')}">
            <i class="fas fa-caret-right"></i>&nbsp;Su DNI
          </h1>
          <div class="control">
            <input
    ...
    <div class="field">
      ...
      <h1 class="subtitle is-6">
        <span class="has-text-link">* Requerido.</span> ¿De que tipo es la propuesta?
      </h1>
      <div class="control">
        <div class="select is-large is-fullwidth">
          ...
          >
            <option :value="null" disabled>- Seleccioná el tipo de propuesta -</option>
