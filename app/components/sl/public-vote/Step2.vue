...
" class="image logo-small-pp-voting is-pulled-right" alt="">
    ...
    <h1 class="subtitle is-6">(Podés cambiarlo antes de enviar tu voto)</h1>
      ...
      <button v-on:click.prevent="$router.push({ name: 'PublicStep1'})" class="button is-primary is-outlined is-fullwidth is-medium">
      <i class="fas fa-reply fa-fw "></i>&nbsp;Cambiar mi selección
    </button> 
      <hr>
    <div class="is-clearfix">
    <button v-on:click.prevent="$router.push({ name: 'PublicConfirm'})" class="button is-primary is-rounded is-medium is-pulled-right">
